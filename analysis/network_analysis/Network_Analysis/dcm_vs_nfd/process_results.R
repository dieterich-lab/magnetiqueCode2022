...
# 100
load(file = "res_dcm_vs_nfd_signif_100_gap_01.RData")
...
write.table(x = network, file = "network_dcm_vs_nfd_100.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
write.table(x = attributes, file = "attributes_dcm_vs_nfd_100.txt", quote = FALSE, sep = "\t", row.names = FALSE, col.names = TRUE)
